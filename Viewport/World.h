...
class World{
     ...
     */
    static const int DIM=24; /*!< Size of lattice dimensions */
    static const int AGENTCOUNT=200; /*!< Initial number of agents */
    ...
    static const int SpiceGrowth=4;
...
//    QHash<QString, Action*> dynamicRules;
...
//    void registerRules(QString, Action*);
//    QHash<QString, Action*> returnRegisteredRules();
